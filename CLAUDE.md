...
`coder`, `researcher`, `writer`, `ops`, `web_design`, `swift`, `ki_expert`, `analyst`, `premium`. Jeder hat eigenes Tool-Set, wird pro Task neu instanziert. `premium` nutzt CLI-Bridge (claude/gemini).
